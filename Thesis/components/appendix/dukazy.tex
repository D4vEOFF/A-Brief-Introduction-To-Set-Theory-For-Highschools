...
\begin{proposition}[de Morganovy vzorce]
...
\begin{proof}
    ...
    Ukážeme si platnost \ref{item:de_morgan_sets_1}, avšak důkaz \ref{item:de_morgan_sets_2} je zcela analogický. Tedy budiž dáno $x\in A \setminus \left(\bigcup_{i=1}^{n}{X_i}\right)$. Z definice rozdílu množin (viz \todo{doplnit odkaz}) tedy musí platit
    \begin{equation*}
