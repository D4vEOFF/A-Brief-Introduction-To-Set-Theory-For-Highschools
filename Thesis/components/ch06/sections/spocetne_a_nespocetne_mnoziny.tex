...
\end{proof}
Překvapivější výsledek, ke kterému došel Georg~Cantor, je ekvipotence množiny přirozených čísel $\N$ a~racionálních čísel $\Q$. To může působit jako zarážející, neboť při pohledu na reálnou osu se zde racionální čísla vyskytují "četněji" oproti přirozeným číslům, přesto však mezi těmito dvěma množinami existuje bijekce.
...
Můžeme tak skutečně konstruovat stále "mohutnější" množiny, čímž vzniká jistá "hierarchie". S tou se však pojí netriviální otázka. V roce 1878 vyslovil Georg~Cantor domněnku, že libovolná podmnožina reálných čísel je buď spočetná, nebo má stejnou mohutnost jako $\R$. (\cite{BalcarStepanek1986}, str. 98.) Formálněji
\begin{equation*}
