...
\end{definition}
Začněme opět příklady, ať víme, jak si takový typ relace vlastně představit. Mějme relace $R_1$ a $R_2$. (Zkuste si sami rozmyslet, zda $R_1,R_2$ splňují podmínky uspořádání.)
\begin{figure}[H]
    \centering
    \includegraphics{ch02_relace_usporadani_1.pdf}
    \caption{Relace uspořádání $R_1$ na šesti prvcích.}
    \label{subfig:relace_usporadani_1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics{ch02_relace_usporadani_2.pdf}
    \caption{Relace uspořádání $R_2$ na devíti prvcích.}
    \label{subfig:relace_usporadani_2}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{subfig:relace_neusporadani_1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics{ch02_relace_neusporadani_2.pdf}
    \caption{Relace $R_2\setminus (x_9,x_6)$, která není uspořádáním.}
    \label{subfig:relace_neusporadani_2}
\end{figure}
\begin{example}
    ...
    \end{enumerate}
\end{example}
Stejně jako u ekvivalence, i zde si můžeme všimnout jisté redundance při zakreslování. Konkrétně dvojice vyplývající z tranzitivity bychom v těchto případech mohli klidně vynechat a považovat za samozřejmé. Zároveň jsme cíleně zakreslili relace $R_1$ a $R_2$ tak, aby šipky vedly pouze nahoru, neboť to činí obrázek přehlednějším. (Toto funguje díky tomu, že v relaci uspořádání se nemohou vyskytnout cykly kvůli podmínce antisymetrie a tranzitivity.) Zkuste se schválně podívat na znázornění relace $R_1$ na obrázku \ref{subfig:relace_usporadani_1_jinak} pro srovnání.
\begin{figure}[H]
    \centering
    \includegraphics{ch02_relace_usporadani_1_jinak.pdf}
    \caption{Relace $R_1$ zakreslená podle pořadí indexů prvků.}
    \label{subfig:relace_usporadani_1_jinak}
\end{figure}
...
\end{figure}
Podobně bychom můžeme zakreslit i relaci $R_1$ z obrázku \ref{subfig:relace_usporadani_1}.
\begin{figure}[H]
    \centering
