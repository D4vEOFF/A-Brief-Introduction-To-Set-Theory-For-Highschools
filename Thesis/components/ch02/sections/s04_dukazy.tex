...
\end{theorem}
(Převzato z \cite{ChartrandPolimeniZhang2014}, str. 144.)\par
...
\end{convention}
\begin{assertion}
    Pro každé $n\geq 5$ platí $2^n>n^2$.
\end{assertion}
\begin{proof}
