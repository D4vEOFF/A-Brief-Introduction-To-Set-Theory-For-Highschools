...
\begin{equation*}
    \neg\big(\forall x(P_x\implies Z_x \land M_x)\big) \iff \Big(\exists x\big(\neg (P_x\implies Z_x \land M_x)\big)\Big)
\end{equation*}
...
\begin{equation*}
    \neg\big(\exists x(P_x\land Z_x \land M_x)\big) \iff \forall x\big(P_x\implies \neg Z_x \lor \neg M_x\big)
\end{equation*}
