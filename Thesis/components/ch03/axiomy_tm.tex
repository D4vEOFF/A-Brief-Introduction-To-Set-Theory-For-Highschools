...
\begin{enumerate}[label=({ZF}\arabic*)]
    ...
    \begin{equation*}
        \forall a\,\exists z\,\forall x\,(x\in z\iff \exists y\,(x\in y \land y\in a))
    \end{equation*}
    ...
    \begin{align*}
        \forall u\,\Big(\forall v\,\forall v^\prime\,(\varphi(u,v) \land \varphi(u,v^\prime) \implies v=v^\prime)\implies\\ \implies \forall a\,\exists z\,\forall x\,\big(x\in y \iff \exists y\,(y\in a \land \varphi(u,y))\big)\Big),
    \end{align*}
