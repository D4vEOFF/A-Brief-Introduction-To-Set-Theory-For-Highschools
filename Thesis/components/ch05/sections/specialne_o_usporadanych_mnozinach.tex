...
\begin{example}\label{ex:min_max_prvek}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \begin{figure}[H]
            ...
            \caption{Diagram uspořádané množiny $(\set{1,2,\dots,10},\mid)$ s nejmenším prvkem a~čtyřmi maximálními prvky.}
            \label{fig:min_max_prvek_ii}
        \end{figure}
        \item\label{item:min_max_prvek_iii} Uspořádaná množina $(A^2,\preceq)$, kde $A=\set{1,2,3}$, definovaná předpisem
        \begin{equation*}
